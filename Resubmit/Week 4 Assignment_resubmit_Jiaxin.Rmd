---
title: "Week 4 Assignment Resubmit"
author: "Jiaxin Zheng"
date: "2024-09-27"
output:
...
```
In conclusion:
As we can see the plots depend on the delay rate for each city. Alaska Air line has lower delay percentages in each city than American West. But the overall plot(first plot), American West in Phoenix holds lowest delay rate.
